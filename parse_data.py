...
def parse_unit_basic_info(html_content,v_type):
...
def parse_ground_data(html,v_type):
    data = {"unit_basic_info":parse_unit_basic_info(html,v_type),"survivability":parse_armor_data(html),"mobility":parse_mobility_data(html),"optics":parse_optics_data(html),"armaments":parse_armaments_data(html)}
    return data
